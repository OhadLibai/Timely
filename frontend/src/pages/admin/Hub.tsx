...
const AdminHub: React.FC = () => {
  ...
  const MLAnalyticsSection = () => (
    <div className="bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 rounded-xl shadow-lg border border-purple-200/50 p-12 relative overflow-hidden">
      ...
      {/* UPDATED: ML Metrics using actual data from hook */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <MetricCard
          title="Precision@K"
          value={metricsData.PrecisionAt?.toFixed(3) || '0.000'}
        ...
        <MetricCard
          title="Recall@K"
          value={metricsData.RecallAt?.toFixed(3) || '0.000'}
        ...
        <MetricCard
          title="F1 Score@K"
          value={metricsData.F1ScoreAt?.toFixed(3) || '0.000'}
        ...
        <MetricCard
          title="NDCG@K"
          value={metricsData.NDCGAt?.toFixed(3) || '0.000'}
        ...
        <MetricCard
          ...
          value={metricsData.JaccardSimilarity?.toFixed(3) || '0.000'}
